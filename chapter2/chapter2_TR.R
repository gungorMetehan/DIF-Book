...
## kitaptaki grafiğin oluşturulması
### x ve y eksenlerindeki değerlerin belirlenmesi
perp <- TIDStats$Dist 
items <- 1:20
### grafiğin çizdirilmesi
plot(items, perp, ylim = c(-3, 3), xaxt = "n", ylab = "Dik UzaklÝklar", xlab = "Maddeler",
...
## üç farklı saflaştırma yöntemine göre analizlerin gerçekleştirilmesi
...
## üç farklı saflaştırma yönteminin orijinal grafikleri
par(mfcol = c(3, 1))
...
# kitaptaki grafikler (üç farklı saflaştırma yöntemi için)
par(mfcol = c(3, 1))
plot(difTID(Data = dataDIF[1:20], group = dataDIF$group1, focal.name = 1, purify = T, purType = "IPP1"), plot = "delta",
...
# 2. Breslow-Day
## homojen ilişkinin testi (Aguerri vd, 2009)
...
## eğilim testi istatistiği (Penfield, 2003)
...
### Breslow-Day (Aguerri vd., 2009) - saflaştırmalı & Breslow-Day (Penfield, 2003) - saflaştırmalı

#### Breslow-Day (Aguerri vd., 2009) - saflaştırmalı
...
#### Breslow-Day (Penfield, 2003) - saflaştırmalı
